    ...
    <app-customers inline-template>
        ...
        <div class="table-full">
            <div class="table-responsive">
                <table class="table table-hover table-condensed" data-sort="table" id="customerTable">
                    <thead>
                    <tr>
                        ...
                        <th class="col-sm-2 text-right">Emails</th>
                        <th class="col-sm-2 text-right">Letters</th>
                    ...
                    <tbody>
                    <tr class="customer"
                        v-for="customer in customers | orderBy order desc"
                        :customer="customer"
                    >
                    ...
                    <tr class="working hide">
                        <th colspan="6" class="text-center btn-default-outline"><i class="fa fa-refresh fa-5x fa-spin"
                                                                                   style="font-size:10em;"></i></th>
                    </tr>
                    </tfoot>
                </table>
